...
interface FormData {
  ...
  image_url: string
  image_path: string
  show_on_homepage: boolean // ini sepertinya tidak digunakan lagi, tapi kita biarkan untuk konsistensi dengan kode lama
  is_popular: boolean
  status: string 
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const result = await createProduct({
        ...
        shipping_info_notes: formData.shipping_info_notes, // Kirim data baru
      })
