...
interface FormData {
  ...
  image_url: string;
  image_path: string;
  is_popular: boolean; // Keep this
  // show_on_homepage: boolean; // Removed
  status: string; 
  careInstructions: {
...
export default function AddProductPage() {
  ...
  const [formData, setFormData] = useState<FormData>({
    ...
    image_url: "",
    image_path: "",
    is_popular: false, // Default for is_popular
  ...
  const handleCheckboxChange = (name: 'is_popular', checked: boolean) => { // Only is_popular now
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const result = await createProduct({
        ...
        is_popular: formData.is_popular, // Pass is_popular
